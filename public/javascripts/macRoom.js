...
function setMacRooms(pageIndex){
	...
	ajax({
		...
		success : function(responseText, responsexml){
			...
			document.getElementById('mac-room-wrapper').innerHTML = '';
			...
			document.getElementById('mac-room-wrapper').appendChild(buttonWrapper);
			...
			if (jsonData.macRooms.length >= PAGE_SIZE) {
